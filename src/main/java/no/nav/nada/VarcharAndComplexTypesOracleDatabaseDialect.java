 ...
 * and overrides standard conversion of STRING to VARCHAR instead of CLOB.
 ...
 */
public class VarcharAndComplexTypesOracleDatabaseDialect extends OracleDatabaseDialect {

    private static String SUB_PROTOCOL_NAME = "oraclevarcharcmplx";

    /**
     * The provider for {@link VarcharAndComplexTypesOracleDatabaseDialect}.
     */
    public static class Provider extends DatabaseDialectProvider.SubprotocolBasedProvider {
        public Provider() {
            super(VarcharAndComplexTypesOracleDatabaseDialect.class.getSimpleName(), SUB_PROTOCOL_NAME);
        }

        @Override
        public DatabaseDialect create(AbstractConfig config) {
            return new VarcharAndComplexTypesOracleDatabaseDialect(config);
        }
    }

    public VarcharAndComplexTypesOracleDatabaseDialect(AbstractConfig config) {
        super(config);
    }
